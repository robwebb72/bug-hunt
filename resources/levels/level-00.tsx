...
<tileset version="1.4" tiledversion="1.4.1" name="bug_hunt_blocks" tilewidth="16" tileheight="16" tilecount="320" columns="20">
 ...
 <tile id="4" type="bullet_only"/>
 <tile id="5" type="bullet_only"/>
 <tile id="6" type="bullet_only"/>
 <tile id="7" type="bullet_only"/>
 ...
 <tile id="83" type="door"/>
 <tile id="84" type="door"/>
 <tile id="85" type="door"/>
 ...
 <tile id="120" type="door,exit"/>
 <tile id="121" type="door,exit"/>
 <tile id="122" type="wall,generator"/>
 <tile id="123" type="wall,generator"/>
 <tile id="124" type="floor,generator"/>
 <tile id="125" type="floor,generator"/>
 <tile id="140" type="floor"/>
 <tile id="141" type="floor"/>
 <tile id="142" type="floor,generator"/>
 <tile id="143" type="floor,generator"/>
 <tile id="144" type="floor,generator"/>
 <tile id="145" type="floor,generator"/>
 <tile id="240" type="pu_health"/>
 <tile id="241" type="pu_ammo"/>
 <tile id="242" type="pu_life"/>
 <tile id="243" type="pu_100c"/>
 <tile id="244" type="pu_1000c"/>
 <tile id="300" type="player_start"/>
</tileset>
